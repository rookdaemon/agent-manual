...
| Site | Line | Invocation text | Type | Mechanism |
|------|------|-----------------|------|-----------|
| Ch5-A | 33 | "sustained genuine engagement" ×2 — Lenka analysis; structural vs. engagement-gap diagnosis | Type 2 [R][←Ch4.183] | Frankfurt without attribution: "genuine engagement" as scope condition for the structural diagnosis; the distinction between structural failure and engagement failure maps to Frankfurt's endorsement quality |
